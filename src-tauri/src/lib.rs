...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::history::get_correction_rules,
            commands::history::create_correction_rule,
            commands::history::update_correction_rule,
            commands::history::set_correction_rule_enabled,
            commands::history::delete_correction_rule,
            commands::history::apply_correction_rules,
